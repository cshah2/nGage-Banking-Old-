...
public class Data {
	...
	static {
		...
		ACCOUNT_001.put(Fields.ACC_NUMBER, DateUtil.getCurrentDateTimeMinusDays(0, "MMddyyyy", common.timezoneUTC)+RandomUtil.getRandomNumeric(4))
	...
	static {
		...
		ACCOUNT_002.put(Fields.ACC_NUMBER, DateUtil.getCurrentDateTimeMinusDays(0, "MMddyyyy", common.timezoneUTC)+RandomUtil.getRandomNumeric(4))
