...
public class Data {
	...
	static {
		...
		CUSTOMER_001_DDA_ACCOUNT.put(Fields.ACC_NUMBER, DateUtil.getCurrentDateTimeMinusDays(0, "MMddyyHHmmss", common.timezoneUTC))
	...
	static {
		...
		CUSTOMER_001_CD_ACCOUNT.put(Fields.ACC_NUMBER, DateUtil.getCurrentDateTimeMinusDays(0, "MMddyyHHmmss", common.timezoneUTC))
	...
	static {
		...
		CUSTOMER_001_SAVING_ACCOUNT.put(Fields.ACC_NUMBER, DateUtil.getCurrentDateTimeMinusDays(0, "MMddyyHHmmss", common.timezoneUTC))
	...
	static {
		...
		CUSTOMER_001_HOLD_ACCOUNT01.put(Fields.ACC_NUMBER, DateUtil.getCurrentDateTimeMinusDays(0, "MMddyyHHmmss", common.timezoneUTC))
	...
	static {
		...
		CUSTOMER_001_HOLD_ACCOUNT02.put(Fields.ACC_NUMBER, DateUtil.getCurrentDateTimeMinusDays(0, "MMddyyHHmmss", common.timezoneUTC))
	...
	static {
		...
		CUSTOMER_001_ORDER_FROM_ACC01.put(Fields.ACC_NUMBER, DateUtil.getCurrentDateTimeMinusDays(0, "MMddyyHHmmss", common.timezoneUTC))
		...
		CUSTOMER_001_ORDER_FROM_ACC01.put(Fields.ACC_OPEN_DATE, DateUtil.getCurrentDateTime(common.dateFormat, common.timezone))
		...
		CUSTOMER_001_ORDER_FROM_ACC01.put(Fields.DOC_SIGNED_DATE, DateUtil.getCurrentDateTime(common.dateTimeFormat, common.timezone))
	...
	static {
		...
		CUSTOMER_001_ORDER_TO_ACC01.put(Fields.ACC_NUMBER, DateUtil.getCurrentDateTimeMinusDays(0, "MMddyyHHmmss", common.timezoneUTC))
		...
		CUSTOMER_001_ORDER_TO_ACC01.put(Fields.ACC_OPEN_DATE, DateUtil.getCurrentDateTime(common.dateFormat, common.timezone))
		...
		CUSTOMER_001_ORDER_TO_ACC01.put(Fields.DOC_SIGNED_DATE, DateUtil.getCurrentDateTime(common.dateTimeFormat, common.timezone))
	...
	static {
		...
		ACCOUNT_001.put(Fields.ACC_NUMBER, DateUtil.getCurrentDateTimeMinusDays(0, 'MMddyyHHmmss', common.timezoneUTC))
	...
	static {
		...
		ACCOUNT_002.put(Fields.ACC_NUMBER, DateUtil.getCurrentDateTimeMinusDays(0, "MMddyyHHmmss", common.timezoneUTC))
