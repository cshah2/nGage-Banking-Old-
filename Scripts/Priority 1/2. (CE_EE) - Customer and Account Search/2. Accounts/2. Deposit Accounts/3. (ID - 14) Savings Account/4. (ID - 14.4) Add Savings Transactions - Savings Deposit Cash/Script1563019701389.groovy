...
Map<Fields, String> txnData1 = Data.CUSTOMER_001_SAVING_ACCOUNT_TXN1
Map<Fields, String> txnData2 = Data.CUSTOMER_001_SAVING_ACCOUNT_TXN2
Map<Fields, String> txnData3 = Data.CUSTOMER_001_SAVING_ACCOUNT_TXN3
...
CustomKeywords.'actions.Common.shouldFailTest'(txnData1)
CustomKeywords.'actions.Common.shouldFailTest'(txnData2)
...
CustomKeywords.'actions.Common.transactionFormFill'(txnData3)
...
CustomKeywords.'actions.Common.reviewTransactionDetails'(txnData3)
...
CustomKeywords.'actions.Common.verifyBalanceSummary'(txnData3)

int rowNo = 1
'Verify data in transaction table in overview tab'
CustomKeywords.'actions.Common.verifyTransactionDetailsInTable'(txnData3, tabOverview_txnTable, rowNo)
...
CustomKeywords.'actions.Common.verifyTransactionDetailsInTable'(txnData3, tabTransaction_txnTable, rowNo)

'Set Flag'
txnData3.put(Fields.IS_CREATED, 'true')
...
CustomKeywords.'actions.Common.verifyTransactionInformationInAccordion'(accData, txnData3)