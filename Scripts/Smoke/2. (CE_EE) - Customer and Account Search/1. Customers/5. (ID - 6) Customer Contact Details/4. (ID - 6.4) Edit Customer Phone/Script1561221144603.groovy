...
CustomKeywords.'utils.WaitFor.elementVisible'(findTestObject('Dashboard Page/Customer and Account Search Page/Customer Details Page/Contact Details Tab/Task Drawer/Customer Phones/input_PhoneNumber'), GlobalVariable.TIMEOUT)

//Verify values from the selected row are loaded in fields
'Verify Phone Number'
WebUI.verifyElementAttributeValue(findTestObject('Dashboard Page/Customer and Account Search Page/Customer Details Page/Contact Details Tab/Task Drawer/Customer Phones/input_PhoneNumber'), 'value', phoneData.get(Fields.CT_PHONE_NUMBER), GlobalVariable.TIMEOUT)

'Verify phone type selected'
WebUI.verifyOptionSelectedByLabel(findTestObject('Dashboard Page/Customer and Account Search Page/Customer Details Page/Contact Details Tab/Task Drawer/Customer Phones/select_PhoneType'), phoneData.get(Fields.CT_PHONE_TYPE), false, GlobalVariable.TIMEOUT)

'Verify phone label'
WebUI.verifyElementAttributeValue(findTestObject('Dashboard Page/Customer and Account Search Page/Customer Details Page/Contact Details Tab/Task Drawer/Customer Phones/input_PhoneLabel'), 'value', phoneData.get(Fields.CT_PHONE_LABEL), GlobalVariable.TIMEOUT)

//Enter updated values in field
'Enter phone number'
WebUI.setText(findTestObject('Dashboard Page/Customer and Account Search Page/Customer Details Page/Contact Details Tab/Task Drawer/Customer Phones/input_PhoneNumber'), phoneEdit.get(Fields.CT_PHONE_NUMBER))

'Select phone type'
WebUI.selectOptionByLabel(findTestObject('Dashboard Page/Customer and Account Search Page/Customer Details Page/Contact Details Tab/Task Drawer/Customer Phones/select_PhoneType'), phoneEdit.get(Fields.CT_PHONE_TYPE), false)

'Enter phone label'
WebUI.setText(findTestObject('Dashboard Page/Customer and Account Search Page/Customer Details Page/Contact Details Tab/Task Drawer/Customer Phones/input_PhoneLabel'), phoneEdit.get(Fields.CT_PHONE_LABEL))
